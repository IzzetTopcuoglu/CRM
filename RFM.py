...
df_ = pd.read_csv("C:/Users/izzet/PycharmProjects/DSMLBC9/DSMLBC9- Ödevler/Modül_2_CRM_Analitiği/Modül_2_CRM_Analitigi/Dataset/flo_data_20k.csv")
df = df_.copy()
df.head()
...
rfm_ = df[['master_id', 'order_num_total', 'customer_value_total']]
...
rfm.head()
rfm__ = pd.DataFrame({"CustomerId": df["master_id"],
